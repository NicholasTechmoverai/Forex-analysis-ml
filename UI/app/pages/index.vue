    ...
    <div class="relative z-10">
        ...
        <div class="flex animate-marquee whitespace-nowrap">
          <div v-for="pair in currencyPairs" :key="pair" class="mx-8 flex items-center space-x-3">
            <UIcon name="i-lucide-trending-up"
              class="w-4 h-4 text-emerald-400 dark:text-emerald-400 light:text-emerald-600" />
      ...
      <UContainer class="py-16 lg:py-24">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
          <div class="space-y-8">
            <div>
              <UBadge variant="subtle" class="mb-4 bg-gradient-to-r from-blue-500/20 to-emerald-500/20 border-blue-500/30
            ...
            <div class="flex flex-col sm:flex-row gap-4">
              <UButton to="/live" size="xl" color="emerald" variant="solid" class="bg-gradient-to-r from-emerald-600 to-cyan-600 hover:from-emerald-500 hover:to-cyan-500
              ...
              <UButton to="/dashboard" size="xl" variant="outline" class="border-gray-600 hover:bg-white/10 dark:border-gray-600 dark:hover:bg-white/10
          ...
          <div class="relative">
            <div class="bg-gray-900/60 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6 shadow-2xl
              ...
              <div class="flex items-center justify-between mb-6">
                ...
                <UBadge color="emerald" variant="subtle" class="dark:bg-emerald-900/30 dark:text-emerald-300
              ...
              <div class="h-64 bg-gradient-to-b from-gray-900/80 to-gray-900/40 rounded-xl p-4 border border-gray-700/30
                ...
                <div class="flex items-end h-full space-x-1">
                  <div v-for="(height, i) in chartHeights" :key="i" :class="`w-3 rounded-t ${height > 60 ? 'bg-emerald-500/80' : 'bg-red-500/80'}
                              ${height > 60 ? 'dark:bg-emerald-500/80' : 'dark:bg-red-500/80'}
                              ${height > 60 ? 'light:bg-emerald-400/80' : 'light:bg-red-400/80'}`"
                    :style="{ height: `${height}%` }" class="transition-all duration-300 hover:opacity-80">
                  </div>
                </div>
              </div>
              ...
              <div class="mt-6 grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div class="flex items-center">
                    ...
                    <span
                      class="text-lg font-bold text-emerald-400 dark:text-emerald-400 light:text-emerald-600">Bullish</span>
                  </div>
                </div>
                <div>
      ...
      <div class="bg-gradient-to-b from-transparent via-gray-900/30 to-gray-900/50 py-20
        ...
        <UContainer>
          <div class="text-center mb-16">
            <UBadge variant="subtle" class="mb-4 bg-gradient-to-r from-purple-500/20 to-pink-500/20 border-purple-500/30
            ...
            <h2 class="text-4xl font-bold text-white dark:text-white light:text-gray-900 mb-4">Machine Learning Pipeline
            </h2>
          ...
          <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <UCard
                ...
                <div class="flex items-center space-x-3">
                  <div class="p-2 rounded-lg bg-blue-500/20 dark:bg-blue-500/20 light:bg-blue-100">
                    <UIcon name="i-lucide-database"
                      class="w-6 h-6 text-blue-400 dark:text-blue-400 light:text-blue-600" />
                  </div>
              ...
              <p class="text-gray-300 dark:text-gray-300 light:text-gray-700">
                Automated collection of forex data from multiple sources with real-time processing and cleaning for AI
                consumption.
              </p>
            </UCard>
                ...
                <div class="flex items-center space-x-3">
                  <div class="p-2 rounded-lg bg-purple-500/20 dark:bg-purple-500/20 light:bg-purple-100">
                    <UIcon name="i-lucide-brain"
                      class="w-6 h-6 text-purple-400 dark:text-purple-400 light:text-purple-600" />
                  </div>
                  <h3 class="text-xl font-bold text-white dark:text-white light:text-gray-900">Neural Networks</h3>
                </div>
              </template>
              <p class="text-gray-300 dark:text-gray-300 light:text-gray-700">
                Custom LSTM and Transformer models trained on historical data to predict price movements and identify
                patterns.
              </p>
            </UCard>
                ...
                <div class="flex items-center space-x-3">
                  <div class="p-2 rounded-lg bg-emerald-500/20 dark:bg-emerald-500/20 light:bg-emerald-100">
                    <UIcon name="i-lucide-line-chart"
                      class="w-6 h-6 text-emerald-400 dark:text-emerald-400 light:text-emerald-600" />
                  </div>
                  <h3 class="text-xl font-bold text-white dark:text-white light:text-gray-900">Backtesting Engine</h3>
                </div>
              </template>
              <p class="text-gray-300 dark:text-gray-300 light:text-gray-700">
                Validate strategies against 15+ years of historical data with realistic commission and slippage
                modeling.
              </p>
            </UCard>
          </div>
        ...
        <div class="relative">
          ...
          <div class="relative bg-gray-900/60 backdrop-blur-sm border border-gray-700/50 rounded-3xl p-12 text-center
            ...
            <div class="max-w-2xl mx-auto">
              ...
              <h2 class="text-3xl font-bold text-white dark:text-white light:text-gray-900 mb-4">Explore the Research
                Environment</h2>
              ...
              <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <UButton to="/live" size="xl" variant="solid" class="bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500
                ...
                <UButton to="/dashboard" size="xl" variant="outline" class="border-gray-600 hover:bg-white/10 text-white dark:border-gray-600 dark:hover:bg-white/10 dark:text-white
                         light:border-gray-300 light:hover:bg-gray-100 light:text-gray-900">
      ...
      <div class="border-t border-gray-800/50 py-16 dark:border-gray-800/50 light:border-gray-200/80">
        <UContainer>
          <UPageCard spotlight class="overflow-hidden border-0 bg-gradient-to-r from-gray-900/80 to-emerald-900/20 
                       dark:from-gray-900/80 dark:to-emerald-900/20
                       light:from-white/90 light:to-emerald-50/60 backdrop-blur-sm">
            <template #header>
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                  <div class="p-2 rounded-lg bg-gradient-to-br from-emerald-500 to-cyan-500">
                    <UIcon name="i-lucide-brain-circuit" class="w-6 h-6 text-white" />
                  </div>
                  <div>
                    <h3 class="text-xl font-bold text-white dark:text-white light:text-gray-900">Research Intelligence
                      Lab</h3>
                    <p class="text-sm text-emerald-300 dark:text-emerald-300 light:text-emerald-600">Advanced Analytics
                      Core</p>
                  </div>
                </div>
            ...
            <div class="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <p class="text-gray-300 dark:text-gray-300 light:text-gray-700 mb-4">
                  The core intelligence engine powers all analytical functions. Continuously learning from market data,
                  this system adapts to changing conditions and improves prediction accuracy over time.
                </p>
                <div class="space-y-3">
                  <div class="flex items-center justify-between text-sm">
                    <span class="text-gray-400 dark:text-gray-400 light:text-gray-600">Model Training</span>
                    <span class="font-mono text-emerald-400 dark:text-emerald-400 light:text-emerald-600">Daily</span>
                  </div>
                  <UProgress v-model="trainVal" size="sm" />

                  <div class="flex items-center justify-between text-sm">
                    <span class="text-gray-400 dark:text-gray-400 light:text-gray-600">Feature Engineering</span>
                    <span class="font-mono text-emerald-400 dark:text-emerald-400 light:text-emerald-600">167+</span>
                  </div>
                  <UProgress v-model="engVal" size="sm" />
                </div>
                <UButton to="/models" size="sm" variant="ghost"
                  class="text-emerald-400 dark:text-emerald-400 light:text-emerald-600">
                  View Technical Details
                  <UIcon name="i-lucide-arrow-right" class="w-4 h-4 ml-1" />
                </UButton>
              </div>

              <img src="/n-logo.png" alt="logo" class="w-full" />
