            ...
            <div v-if="(!isMobile || showRightPanel) && isChartReady" :class="[
                ...
                <div
                    ...
                    <h3
                        ...
                        <div class="flex items-center gap-2">
                            <UIcon name="i-heroicons-minus" class="w-5 h-5 text-blue-500" />
                            Horizontal Lines
                        </div>
                        <button @click="clearHorizontalLines"
                ...
                <div
                    class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 border border-gray-200 dark:border-gray-700 mb-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                        <UIcon name="i-heroicons-arrows-up-down" class="w-5 h-5 text-blue-500" />
                        Support/Resistance
                    </h3>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-900/30 rounded-lg">
                            ...
                            <button @click="showSupportResistance = !showSupportResistance" :class="[
                                'relative inline-flex h-6 w-11 items-center rounded-full transition-colors',
                                showSupportResistance ? 'bg-green-500' : 'bg-gray-300 dark:bg-gray-600'
                            ]">
                                <span :class="[
                                    'inline-block h-4 w-4 transform rounded-full bg-white transition-transform',
                                    showSupportResistance ? 'translate-x-6' : 'translate-x-1'
                                ]" />
                            </button>
                        </div>
                        ...
                        <div v-if="showSupportResistance && supportResistanceLevels.length > 0"
                            ...
                            <p class="text-xs font-medium text-blue-700 dark:text-blue-400 mb-2">
                ...
                <div
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-900/30 rounded-lg">
                            ...
                            <button @click="toggleAutoZoom" :class="[
                                'relative inline-flex h-6 w-11 items-center rounded-full transition-colors',
                                autoZoom ? 'bg-green-500' : 'bg-gray-300 dark:bg-gray-600'
                            ]">
                                <span :class="[
                                    'inline-block h-4 w-4 transform rounded-full bg-white transition-transform',
                                    autoZoom ? 'translate-x-6' : 'translate-x-1'
                                ]" />
                            </button>
                        </div>
                ...
                <div
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                        <UIcon name="i-heroicons-wrench-screwdriver" class="w-5 h-5 text-blue-500" />
                        Tools
                    </h3>
